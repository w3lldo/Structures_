...
lazy val testSettings = Seq(
  ...
  javaOptions in Test ++= (Seq(
    ...
    case Some(value) =>Seq(s"-Dfs2.test.verbose=true")
    case None => Seq()
  })),
...
/*
//  A tool for diagnosing binary incompatibilities for Scala libraries
...
lazy val core = crossProject(JVMPlatform, JSPlatform)
  ...
  .settings(
    ...
    sourceDirectories in Compile += baseDirectory.value / "../shared/src/main/scala",
